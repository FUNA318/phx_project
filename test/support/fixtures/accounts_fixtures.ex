defmodule PhxProject.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `PhxProject.Accounts` context.
  """
  ...
  def user_fixture(attrs \\ %{}) do
    {:ok, user} =
      ...
      |> PhxProject.Accounts.create_user()
  ...
  def credential_fixture(attrs \\ %{}) do
    {:ok, credential} =
      ...
      |> PhxProject.Accounts.create_credential()
