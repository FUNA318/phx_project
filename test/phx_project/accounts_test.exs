defmodule PhxProject.AccountsTest do
  use PhxProject.DataCase

  alias PhxProject.Accounts

  describe "users" do
    alias PhxProject.Accounts.User

    import PhxProject.AccountsFixtures
  ...
  describe "credentials" do
    alias PhxProject.Accounts.Credential
